...
<head>
    <title>Pizzería Primavera</title>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="w3-content">
            ...
            <div class="w3-row w3-center w3-border w3-border-dark-grey">
                <a href="javascript:void(0)" onclick="openMenu(event, 'Pizza');" id="myLink">
                    <div class="w3-col tablink w3-padding-large w3-hover-red">Pizza</div>
                </a>
            </div>
            ...
            <div id="Pizza" class="w3-container menu w3-padding-32 w3-white">
                ...
                <h1><b>{{$pizza->name}}</b> <span class="w3-right w3-tag w3-dark-grey w3-round">Gs. {{$pizza->price}}</span></h1>
    ...
    <div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
        <div class="w3-content">
            ...
            <p><strong>The Chef?</strong> Mr. Italiano himself<img src="https://www.w3schools.com/w3images/chef.jpg" style="width:150px"
    ...
    <div class="w3-container w3-padding-64 w3-blue-grey w3-grayscale-min w3-xlarge">
        <div class="w3-content">
            ...
            <p><span class="w3-tag">FYI!</span> We offer full-service catering for any event, large or small. We
                ...
                and taste.</p>
            <p class="w3-xxlarge"><strong>Reserve</strong> a table, ask for today's special or just send us a message:
            </p>
